...
export function QuestionEditor({
  ...
  return (
    <div className="bg-gray-50 rounded-3xl border-2 border-gray-100">
      <div className="flex items-center gap-2 p-4 sm:p-5">
        ...
        >
          <div
            className="w-10 h-10 shrink-0 rounded-xl flex items-center justify-center text-white font-black text-lg"
            style={{
        ...
        {canRemove && (
          <button
            ...
            className="p-2 shrink-0 text-gray-400 hover:text-[#E21B3C] hover:bg-red-50 rounded-xl transition-all"
          >
