/**
 * Tests de `TimeBonusScoring` (US-10).
 *
 * Los valores espejo provienen de `QuizUpWebSocket/src/core/domain/scoring/time-bonus-scoring.test.ts`
 * (US-04), que a su vez los portó de `gameStore.test.ts` (US-01) con el reloj real:
 * 2001, 1950, 1, 0.
 */
import { describe, expect, it } from "vitest";
import { TimeBonusScoring } from "./time-bonus-scoring";
